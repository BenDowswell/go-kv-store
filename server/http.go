...
func Routes(store kvstore.Store) http.Handler {
...
func Start(store kvstore.Store, addr string) error {
...
func getKey(w http.ResponseWriter, r *http.Request, store kvstore.Store) {
...
func updateKey(w http.ResponseWriter, r *http.Request, store kvstore.Store) {
...
func deleteKey(w http.ResponseWriter, r *http.Request, store kvstore.Store) {
